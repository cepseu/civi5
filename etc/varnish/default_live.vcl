...
#      "Connection: close";
#    .port      = "8080";
#    .interval  = 20s; # check the health of each backend every 20 seconds
...
# Switch debug header after testing to hide varnish
...
#  }
  ...
  # Set some headers
  set resp.http.Server = "www.ceps.eu";
  set resp.http.X-Powered-By = "www.ceps.eu";
  set resp.http.X-Generator = "www.ceps.eu";
